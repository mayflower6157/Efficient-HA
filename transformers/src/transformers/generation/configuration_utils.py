...
class GenerationConfig(PushToHubMixin):
    ...
    def __init__(self, **kwargs):
        ...
        self.cd_alpha = kwargs.pop("cd_alpha", None)
        self.cd_beta = kwargs.pop("cd_beta", None)
        self.alpha = kwargs.pop("alpha", None)
        self.threshold_top_p = kwargs.pop("threshold_top_p", None)
        self.threshold_top_k = kwargs.pop("threshold_top_k", None)
        self.early_exit_layers= kwargs.pop("early_exit_layers", None)
