...
def get_args():
    ...
    parser.add_argument('--output_path', type=str, default="/home/li0007xu/P1/TTAH/Qwen2.5-VL/llava_mme_dola.jsonl")
    parser.add_argument('--seed', default=0, type=int)
    parser.add_argument('--log_path', type=str, default="/home/li0007xu/P1/TTAH/Qwen2.5-VL/llava_mme_dola")
...
if __name__ == "__main__":
    ...
    args = get_args()
    GT = get_gt(data_path='/home/DTC_SSD/Zhaoxu/MME_Benchmark_release_version/MME_Benchmark/')# /path/to/experiments/data/MME_Benchmark_release_version')
