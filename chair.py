...
if __name__ == '__main__':
    ...
    parser.add_argument("--caption_key", type=str, default="response",
    ...
    parser.add_argument("--coco_path", type=str, default='/home/li0007xu/Reasoning/Deco/annotations_2014_coco',
