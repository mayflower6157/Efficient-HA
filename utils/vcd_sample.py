    ...
    **model_kwargs,
    ...
    while self._has_unfinished_sequences(this_peer_finished, synced_gpus, device=input_ids.device):
        ...
        ## cd_comments: forward pass of the model with distorted image input
            ...
            model_inputs_cd.update({"output_attentions": output_attentions_wo_img} if output_attentions else {})
            model_inputs_cd.update({"output_hidden_states": output_hidden_states_wo_img} if output_hidden_states else {})
            outputs_cd = self(
                **model_inputs_cd,
                return_dict=True,
