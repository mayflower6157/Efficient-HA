...
def get_args():
    ...
    parser.add_argument("--word_association", type=str, default='/home/li0007xu/P1/TTAH/Qwen2.5-VL/amberdata/AMBER/data/relation.json')
    parser.add_argument("--safe_words", type=str, default='/home/li0007xu/P1/TTAH/Qwen2.5-VL/amberdata/AMBER/data/safe_words.txt')
    parser.add_argument("--inference_data", default='/home/li0007xu/P1/TTAH/Qwen2.5-VL/amberdata/amberlog/amber/ourstta_a_0.6_tops_50_topp-k0.9-20-s_50-t_30-num_can_5-p_1.0-max_64-deco_dola_beamsize_5_generated_captions.jsonl',type=str)
    parser.add_argument("--annotation", type=str, default='/home/li0007xu/P1/TTAH/Qwen2.5-VL/amberdata/AMBER/data/annotations.json')
    parser.add_argument("--metrics", type=str, default='/home/li0007xu/P1/TTAH/Qwen2.5-VL/amberdata/AMBER/data/metrics.txt')
    parser.add_argument("--similarity_score", type=float, default=0.8)
    parser.add_argument('--evaluation_type', default='a',choices=['a', 'g', 'd', 'de', 'da', 'dr'], help='a: all tasks and dimensions    g: generative task    d: descriminative task    de, da, dr: existence, attribute, relation')
...
def main(args):
    ...
    for i in tqdm(range(len(inference_data))):
        ...
        if ground_truth[id-1]['type'] == 'generative':
            ...
            response= re.findall(r'\b(?:Yes|No)\b', response, re.IGNORECASE)
